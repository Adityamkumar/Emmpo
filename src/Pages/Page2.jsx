...
const Page2 = () => {
  ...
  return (
    <div ref={page2Ref} className='w-full h-full bg-[#F9F5EC] overflow-hidden'>
        <img className='py-40 w-40 m-auto ' src="/images/cross.png" alt="" />
        <div className='relative w-full text-center -mt-36 font-["font1"] z-[2]'>
            ...
            <div ref={img4Ref}>
               <img src="/images/caImg1.png" alt="" />
               <img className='absolute top-52 left-30' src="/images/caDare.png" alt="" />
            </div>
        </div>
        </div>
        <div className='w-full flex  justify-around'>
            <div ref={img1Ref} className='relative ml-20'>
                <img className='w-68 -rotate-20' src="/images/caImg4.png" alt="" />
                <img className='w-44 absolute top-78 left-36' src="/images/ca-dream.png" alt="" />
            </div>
            <div ref={img2Ref} className='relative w-[430px] h-[440px] bg-[#F8FE23] p-4 mt-26 ml-20 font-["font1"]'>
                <img src="/images/caImg3.png" alt="" />
                ...
                <img className='absolute w-14  top-105 left-8' src="/images/ca-butter.png" alt="" />
            </div>
            <div ref={img3Ref} className='relative'>
               <img className='w-60 mr-30 mt-8 rotate-20' src="/images/caImg2.png" alt="" /> 
               <img className='w-70 absolute top-46 left-7' src="/images/ca-pass.png" alt="" />
            </div>
        </div>

        <div className='relative -mt-50 w-full flex justify-between items-center'>
            <div>
                <img ref={imglRef} className='w-54 -rotate-25 ml-2' src="/images/caImg5.png" alt="" />
            </div>
            ...
            <div>
                <img ref={imgrRef} className='w-54 rotate-23' src="/images/caImg6.png" alt="" />
            </div>
        </div>
